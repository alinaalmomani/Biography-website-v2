    ...
    <div class="container">
      ...
      <div class="year__filter">
        <div class="row mix eighteen">
          <div class="col-md-8">
            <div class="project img ftco-animate img-2 d-flex justify-content-center align-items-center"
              style="background-image: url(images/2018/Big\ summit/IMG-20180110-WA0028.jpg);">
              <div class="overlay"></div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                  style="background-image: url(images/2018/During\ a\ session\ at\ the\ MENA\ ICT\ FORUM/Pic1.jpg);">
                  <div class="overlay"></div>
                  <div class="text text-center p-4">
              ...
              <div class="col-md-12">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                  style="background-image: url(images/2018/Fiber/DSC_6622\ copy\(s\).jpg);">
                  <div class="overlay"></div>
                  <div class="text text-center p-4">
          ...
          <div class="col-md-4">
            <div class="project img ftco-animate d-flex justify-content-center align-items-center"
              style="background-image: url(images/2018/Fiber/DSC_6896\ copy\(s\).jpg);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
                <h3><a href="#">Fiber</a></h3>
              </div>
          ...
          <div class="col-md-8">
            <div class="project img ftco-animate d-flex justify-content-center align-items-center"
              style="background-image: url(images/2018/King\ Abdullah\ II\ Award\ for\ Excellence\ ceremony/IMG_5543\ copy\(s\).jpg);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
        ...
        <div class="row mix eighteen">
          <div class="col-md-8">
            <div class="project img ftco-animate img-2 d-flex justify-content-center align-items-center"
              style="background-image: url(images/2018/King\ Abdullah\ II\ Award\ for\ Excellence\ ceremony/pic2.jpg);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
                <h3><a href="#">King Abdullah II Award for Excellence ceremony</a></h3>
              </div>
        ...
        <div class="row mix nineteen">
          <div class="col-md-4">
            <div class="project img ftco-animate d-flex justify-content-center align-items-center"
              style="background-image: url(images/2019/coding\ academy/7E9A3838\ copy.jpg);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
          ...
          <div class="col-md-4">
            <div class="project img ftco-animate d-flex justify-content-center align-items-center"
              style="background-image: url(images/2019/Data\ center/Pic1.JPG);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
          ...
          <div class="col-md-8">
            <div class="project img ftco-animate d-flex justify-content-center align-items-center"
              style="background-image: url(images/2019/e-sim/Circular\ economy\ image.jpg);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
        ...
        <div class="row mix nineteen">
          <div class="col-md-8">
            <div class="project img ftco-animate img-2 d-flex justify-content-center align-items-center"
              style="background-image: url(images/2019/EFQM/Pic\ 2\ \ .JPG);">
              <div class="overlay"></div>
              <div class="text text-center p-4">
                <h3><a href="#">EFQM</a></h3>
              </div>
